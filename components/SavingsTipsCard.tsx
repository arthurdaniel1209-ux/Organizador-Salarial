    ...
    <div className="bg-white/60 backdrop-blur-sm dark:bg-slate-800/60 p-6 rounded-2xl shadow-lg">
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold dark:text-slate-100">Dicas com IA</h2>
        </div>
      </div>
      ...
      <div className="space-y-3 min-h-[120px] flex flex-col justify-center">
        {loading && (
          <div className="text-center">
            <p className="text-slate-500 dark:text-slate-400 animate-pulse">Analisando suas finanças...</p>
          </div>
        )}
        {error && !loading && (
        ...
        {!loading && !error && tips.length === 0 && (
          <div className="text-center">
            <p className="text-slate-500 dark:text-slate-400">Clique para receber dicas de economia personalizadas com base no seu orçamento.</p>
          </div>
        )}
      </div>
